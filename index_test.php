        ...
        <section class="market-section">
            <div class="container">
                ...
                <?php
                    ...
                    if($val == 1){ ?>
                         <p style="color: #c55511; font-weight: bold;">MARKET OPEN </p>
                    <?php } else { ?>
                            <p style="color: #c55511; font-weight: bold;">MARKET CLOSE </p>
                    <?php } ?>
                </div>
        ...
        <section class="disclaimer">
        	<div class="container">
            	<div class="col-12 text-center">
                  	<p><strong>Disclaimer :</strong> Purchase of lottery using this website is strictly prohibited in the states where lotteries are banned. You must be above 18 years to play Online Lottery.</p>
                </div>
            </div>
        </section>
        <footer>
